...
extern GType gdata_parsable_get_type(void);
extern GType gdata_category_get_type(void);
extern GType gdata_link_get_type(void);
extern GType gdata_author_get_type(void);
extern GType gdata_entry_get_type(void);
extern GType gdata_generator_get_type(void);
extern GType gdata_feed_get_type(void);
extern GType gdata_authorization_domain_get_type(void);
extern GType gdata_authorizer_get_type(void);
extern GType gdata_service_get_type(void);
extern GType gdata_query_get_type(void);
extern GType gdata_color_get_type(void);
extern GType gdata_operation_type_get_type(void);
extern GType gdata_service_error_get_type(void);
extern GType gdata_parser_error_get_type(void);
extern GType gdata_batch_operation_type_get_type(void);
extern GType gdata_client_login_authorizer_error_get_type(void);
extern GType gdata_access_rule_get_type(void);
extern GType gdata_access_handler_get_type(void);
extern GType gdata_download_stream_get_type(void);
extern GType gdata_upload_stream_get_type(void);
extern GType gdata_comparable_get_type(void);
extern GType gdata_batch_operation_get_type(void);
extern GType gdata_batchable_get_type(void);
extern GType gdata_client_login_authorizer_get_type(void);
extern GType gdata_oauth1_authorizer_get_type(void);
extern GType gdata_comment_get_type(void);
extern GType gdata_commentable_get_type(void);
extern GType gdata_app_categories_get_type(void);
extern GType gdata_gd_email_address_get_type(void);
extern GType gdata_gd_im_address_get_type(void);
extern GType gdata_gd_name_get_type(void);
extern GType gdata_gd_where_get_type(void);
extern GType gdata_gd_organization_get_type(void);
extern GType gdata_gd_phone_number_get_type(void);
extern GType gdata_gd_postal_address_get_type(void);
extern GType gdata_gd_reminder_get_type(void);
extern GType gdata_gd_when_get_type(void);
extern GType gdata_gd_who_get_type(void);
extern GType gdata_gcontact_calendar_get_type(void);
extern GType gdata_gcontact_event_get_type(void);
extern GType gdata_gcontact_external_id_get_type(void);
extern GType gdata_gcontact_jot_get_type(void);
extern GType gdata_gcontact_language_get_type(void);
extern GType gdata_gcontact_relation_get_type(void);
extern GType gdata_gcontact_website_get_type(void);
extern GType gdata_media_category_get_type(void);
extern GType gdata_media_content_get_type(void);
extern GType gdata_media_credit_get_type(void);
extern GType gdata_media_expression_get_type(void);
extern GType gdata_media_medium_get_type(void);
extern GType gdata_media_thumbnail_get_type(void);
extern GType gdata_youtube_content_get_type(void);
extern GType gdata_youtube_credit_get_type(void);
extern GType gdata_youtube_state_get_type(void);
extern GType gdata_youtube_video_get_type(void);
extern GType gdata_youtube_service_get_type(void);
extern GType gdata_youtube_standard_feed_type_get_type(void);
extern GType gdata_youtube_service_error_get_type(void);
extern GType gdata_youtube_permission_get_type(void);
extern GType gdata_youtube_format_get_type(void);
extern GType gdata_youtube_safe_search_get_type(void);
extern GType gdata_youtube_sort_order_get_type(void);
extern GType gdata_youtube_age_get_type(void);
extern GType gdata_youtube_uploader_get_type(void);
extern GType gdata_youtube_query_get_type(void);
extern GType gdata_youtube_category_get_type(void);
extern GType gdata_youtube_comment_get_type(void);
extern GType gdata_calendar_calendar_get_type(void);
extern GType gdata_calendar_service_get_type(void);
extern GType gdata_calendar_event_get_type(void);
extern GType gdata_calendar_feed_get_type(void);
extern GType gdata_calendar_query_get_type(void);
extern GType gdata_picasaweb_album_get_type(void);
extern GType gdata_picasaweb_user_get_type(void);
extern GType gdata_picasaweb_service_get_type(void);
extern GType gdata_picasaweb_query_get_type(void);
extern GType gdata_picasaweb_file_get_type(void);
extern GType gdata_picasaweb_feed_get_type(void);
extern GType gdata_picasaweb_visibility_get_type(void);
extern GType gdata_picasaweb_comment_get_type(void);
extern GType gdata_contacts_service_get_type(void);
extern GType gdata_contacts_contact_get_type(void);
extern GType gdata_contacts_group_get_type(void);
extern GType gdata_contacts_query_get_type(void);
extern GType gdata_documents_entry_get_type(void);
extern GType gdata_documents_document_get_type(void);
extern GType gdata_documents_query_get_type(void);
extern GType gdata_documents_feed_get_type(void);
extern GType gdata_documents_service_get_type(void);
extern GType gdata_documents_folder_get_type(void);
extern GType gdata_documents_upload_query_get_type(void);
extern GType gdata_documents_text_get_type(void);
extern GType gdata_documents_spreadsheet_get_type(void);
extern GType gdata_documents_presentation_get_type(void);
extern GType gdata_documents_drawing_get_type(void);
extern GType gdata_documents_pdf_get_type(void);
extern GType gdata_documents_service_error_get_type(void);
extern GType gdata_goa_authorizer_get_type(void);
...
extern GQuark gdata_parser_error_quark(void);
extern GQuark gdata_service_error_quark(void);
extern GQuark gdata_client_login_authorizer_error_quark(void);
extern GQuark gdata_youtube_service_error_quark(void);
extern GQuark gdata_documents_service_error_quark(void);
GQuark (*GI_ERROR_QUARK_FUNCS_[])(void) = {
