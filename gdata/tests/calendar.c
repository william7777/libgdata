...
test_event_json_dates (void){
	...
	event = GDATA_CALENDAR_EVENT(gdata_parsable_new_from_json(GDATA_TYPE_CALENDAR_EVENT, 
                "{\"kind\": \"calendar#event\","
		"\"etag\": \"\\\"-kteSF26GsdKQ5bfmcd4H3_-u3g/Mjc1NTU2MzExNzU5MTAwMA\\\"\","
		...
		"\"extendedProperties\": {"
			"\"private\":{"
				"\"privateKey1\": \"privateValue1\","
				"\"privateKey2\": \"privateValue2\","
				"\"privateKey3\": \"privateValue3\""
			"},"
			"\"shared\":{"
				"\"sharedKey1\": \"sharedValue1\","
				"\"sharedKey2\": \"sharedValue2\","
				"\"sharedKey3\": \"sharedValue3\""
			"}"
		"},"
		"\"hangoutLink\": \"itsahangoutlink.google.com\","
		"\"gadget\":{"
			"\"type\": \"sometype\","
			"\"title\": \"sometitle\","
			"\"link\": \"somelink\","
			"\"iconLink\": \"someiconlink\","
			"\"width\": 25,"
			"\"height\": 25,"
			"\"display\": \"somedisplay\","
			"\"preferences\": {"
